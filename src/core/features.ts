...
class Features {
  ...
  static supportMSEH264Playback(): boolean {
    ...
    const support_apple_mme = !!Features.getManagedMediaSourceConstructor() && Features.getManagedMediaSourceConstructor()!.isTypeSupported(avc_aac_mime_type)
  ...
  static supportMSEH265Playback(): boolean {
    ...
    const support_apple_mme = !!Features.getManagedMediaSourceConstructor() && Features.getManagedMediaSourceConstructor()!.isTypeSupported(hevc_mime_type)
    return support_w3c_mse || support_apple_mme
  }
  ...
  private static getManagedMediaSourceConstructor(): ManagedMediaSourceConstructor | undefined {
